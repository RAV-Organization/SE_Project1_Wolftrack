...
|-----|---------|----------|
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others... but nevertheless, here is a track record that everyone is contributing a lot)| 3 | Everyone has committed and contributed equally. [Visible in Insights -> Contributors](https://github.com/RAV-Organization/SE_Project1_Wolftrack/tree/wolftrack6.0)|
|Number of commits| 3 | Many commits were made [Available in Commit Tree](https://github.com/RAV-Organization/SE_Project1_Wolftrack/commits/wolftrack6.0/) |
|Number of commits: by different people| 3 | Different features by different people and modifications [Commits by everyone are visible Tree](https://github.com/RAV-Organization/SE_Project1_Wolftrack/commits/wolftrack6.0/)|
|Issues reports: Several issues were created | 3 | [Issues](https://github.com/RAV-Organization/SE_Project1_Wolftrack/issues) |
|Issues are being closed| 3 | Closed Issues -> [Closed](https://github.com/RAV-Organization/SE_Project1_Wolftrack/issues?q=is%3Aissue+is%3Aclosed) |
|Docs: doco generated, format not ugly | 3 | Documentation is added [GitHub Repository](https://github.com/RAV-Organization/SE_Project1_Wolftrack/commits/wolftrack6.0/) |
|Docs: what: point descriptions of each class/function (in isolation) | 3 | Example in [GitHub Repository](https://github.com/RAV-Organization/SE_Project1_Wolftrack/commits/wolftrack6.0/)|
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z| 3 |INSTALL.md [Install](https://github.com/RAV-Organization/SE_Project1_Wolftrack/commits/wolftrack6.0/) |
|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing| 3 | Readme includes the whole story, and will make other people to take on our project [GitHub Repository](https://github.com/RAV-Organization/SE_Project1_Wolftrack/commits/wolftrack6.0/)|
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.|  3| Video is present on the repo [GitHub Repository](https://github.com/RAV-Organization/SE_Project1_Wolftrack/commits/wolftrack6.0/)|
|Use of version control tools| 3 | Git was used by the team|
|Test cases exist| 3 |Test cases are present in tests folder for each module [see here](https://github.com/RAV-Organization/SE_Project1_Wolftrack/tree/wolftrack6.0/UnitTesting)|
|Test cases are routinely executed| 3 |Test cases are executed using Github Actions at every push, pull request, merge etc.|
|Issues are discussed before they are closed| 3 |[Issue](https://github.com/RAV-Organization/SE_Project1_Wolftrack/issues)|
|Chat channel: exists| 3 | Housemates so most of the interaaction was in person |
|Test cases: a large proportion of the issues related to handling failing cases.| 3 | [Issue](https://github.com/RAV-Organization/SE_Project1_Wolftrack/issues)|
|Evidence that the whole team is using the same tools: everyone can get to all tools and files| 3 | Everyone has worked on different features|
|Evidence that the whole team is using the same tools | 3 | |
|Evidence that the whole team is using the same tools (e.g. tutor can ask anyone to share screen, they demonstrate the system running on their computer)| 3 | Everyone has their own seperate branches for features |
|Evidence that the members of the team are working across multiple places in the code base| 3 | Team members have worked on different large features as well as small bug fixes and changes|
...
|Video| 3 | |
|DOI badge: exists. To get a Digitial Object Indentifier, regiser the project at Zenodo.| 3 | Yes |
