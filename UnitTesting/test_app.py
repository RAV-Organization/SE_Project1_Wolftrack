...
class TestFlaskApp(TestCase):
    ...
    def test_add_New_route(self):
        ...
        response = self.client.post(
            '/student/add_New', data=data, follow_redirects=True)
    ...
    def test_send_invaid_email_route(self):
        ...
        response = self.client.post(
            '/admin/send_email', data=data, follow_redirects=True)
        self.assert400(response)
    ...
    def test_student_route(self):
        ...
        response = self.client.post(
            '/student', data=data, follow_redirects=True)
        self.assert200(response)
    ...
    def test_display_route(self, mock_listdir):
        ...
        mock_listdir.return_value = [
            'Shreya Vaidya_Resume.pdf', 'file2.txt', 'file3.txt']
    ...
    def test_add_job_application_invalid_data(self):
        ...
        response = self.client.post(
            '/add_job_application', data=data, follow_redirects=True)
        self.assert400(response)
    ...
    def test_update_job_application_invalid_data(self):
        ...
        response = self.client.post(
            '/student/update_job_application', data=data, follow_redirects=True)
        self.assert400(response)
    ...
    def test_delete_job_application_invalid_data(self):
        ...
        response = self.client.post(
            f'/student/delete_job_application/{company}', follow_redirects=True)
        self.assert400(response)
    ...
    def test_upload_incorrect_files(self):
        ...
        response = self.client.post(
            '/student/upload', data=data, follow_redirects=True)
        self.assert400(response)
